...
if ($_SERVER['HTTP_HOST'] == 'localhost'):
    define('SIS_DB_HOST', getenv('SIS_DB_HOST') ?: 'localhost'); //Link do banco de dados no localhost
    define('SIS_DB_USER', getenv('SIS_DB_USER') ?: 'root'); //Usuário do banco de dados no localhost
    define('SIS_DB_PASS', getenv('SIS_DB_PASS') ?: ''); //Senha do banco de dados no localhost
    define('SIS_DB_DBSA', getenv('SIS_DB_DBSA') ?: 'charme_fitness'); //Nome do banco de dados no localhost
else:
    // Configure in production via env (recommended) or via DB settings if you use SIS_CONFIG_WC.
    define('SIS_DB_HOST', getenv('SIS_DB_HOST') ?: ''); //Link do banco de dados no servidor
    define('SIS_DB_USER', getenv('SIS_DB_USER') ?: ''); //Usuário do banco de dados no servidor
    define('SIS_DB_PASS', getenv('SIS_DB_PASS') ?: ''); //Senha do banco de dados no servidor
    define('SIS_DB_DBSA', getenv('SIS_DB_DBSA') ?: ''); //Nome do banco de dados no servidor
endif;
/*
 * CACHE E CONFIG
 */
...
define('DB_PDT_GROUPS_ATTR', 'ws_products_groups_attributes'); //Tabela de grupos de atributos
define('DB_PDT_ATTR_SIZES', 'ws_products_attributes_sizes'); //Tabela de atributos de tamanhos
define('DB_PDT_ATTR_COLORS', 'ws_products_attributes_colors'); //Tabela de atributos de cores
define('DB_PDT_ATTR_PRINTS', 'ws_products_attributes_prints'); //Tabela de atributos de estampas
...
define('DB_PDT_COMBO', 'ws_products_combo'); //Tabela de compre juntos
define('DB_PDT_COUPONS', 'ws_products_coupons'); //Tabela de Cupons de desconto
define('DB_PDT_WISHLIST', 'ws_products_wishlist'); //Tabela de lista de desejos
define('DB_PDT_ABANDONED_CART', 'ws_products_abandoned_cart'); //Tabela de abandono de carrinho
...
define('DB_FREIGHTS', 'freights'); //Tabela de fretes
...
function getOrderPayment($Payment = null) {
    $Payments = [
        1 => 'Pendente',
        101 => 'Cartão de Crédito', //PAGSEGURO, PAGARME
        102 => 'Boleto Bancário' //PAGSEGURO, PAGARME
    ];
...
function getShipmentTag($Tag = null) {
    $ArrShipment = [
        ...
        '10006' => 'TNT - Rodoviário',
        '10007' => 'TNT - Aéreo',
        '10008' => 'Jamef - Rodoviário',
        '10009' => 'Jamef - Aéreo',
        '10010' => 'Jadlog Expresso',
        '10011' => 'Jadlog Package',
        '10012' => 'Jadlog Rodoviário',
        '10013' => 'Jadlog Econômico',
        '10014' => 'Jadlog DOC',
        '10015' => 'Jadlog Corporate',
        '10016' => 'Jadlog COM',
        '10017' => 'Jadlog Internacional',
        '10018' => 'Jadlog Cargo',
        '10019' => 'Jadlog Emergencial',
        '4014' => 'Sedex', //04014 SEDEX sem contrato.
        ...
        '40169' => 'Sedex 12', //40169 SEDEX 12, sem contrato.
        '40290' => 'Sedex Hoje', //40290 SEDEX Hoje, sem contrato.
        '4162' => 'Sedex', //04162 SEDEX com contrato.
        ...
        '4510' => 'PAC', //04510 PAC sem contrato.
        '4669' => 'PAC', //04669 PAC com contrato.
