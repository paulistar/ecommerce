...
if (!$WorkControlDefineConf):
     ...
     */
    define('MAIL_HOST', getenv('MAIL_HOST') ?: 'charmefitness.com.br'); //Servidor de e-mail
    define('MAIL_PORT', getenv('MAIL_PORT') ?: '465'); //Porta de envio
    define('MAIL_USER', getenv('MAIL_USER') ?: 'contato@charmefitness.com.br'); //E-mail de envio
    define('MAIL_SMTP', getenv('MAIL_SMTP') ?: (getenv('MAIL_USER') ?: 'contato@charmefitness.com.br')); //E-mail autenticador do envio
    define('MAIL_PASS', getenv('MAIL_PASS') ?: ''); //Senha do e-mail de envio (set via env no deploy)
    define('MAIL_SENDER', getenv('MAIL_SENDER') ?: 'Charme Fitness'); //Nome do remetente de e-mail
    define('MAIL_MODE', getenv('MAIL_MODE') ?: 'ssl'); //Encriptação para envio de e-mail [0 não parametrizar / tls / ssl] (Padrão = tls)
    define('MAIL_TESTER', getenv('MAIL_TESTER') ?: ''); //E-mail de testes (DEV)
    ...
    // IMPORTANT: never hardcode secrets in git. Configure via env or via DB (when SIS_CONFIG_WC=1).
    define('ACTIVE_CAMPAIGN_URL', getenv('ACTIVE_CAMPAIGN_URL') ?: ''); //URL da conta ActiveCampaign
    define('ACTIVE_CAMPAIGN_KEY', getenv('ACTIVE_CAMPAIGN_KEY') ?: ''); //KEY da conta ActiveCampaign
